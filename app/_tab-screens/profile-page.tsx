...
export function ProfilePage({ screenId }) {
  return (
    <View screenType={ViewTypes.TAB} screenId={screenId}>
      ...
      {/*</List>*/}
      <Block>
        Click <InAppLink href='/post/abc-11123'>here</InAppLink> to view a post.
      </Block>
      <Block>
        Click <InAppLink href='/user/abc-11123'>here</InAppLink> to view a user.
      </Block>
      <Block>
        Click <InAppLink href='/content/abc-11123'>here</InAppLink> to view a
        content page.
      </Block>
      <br />

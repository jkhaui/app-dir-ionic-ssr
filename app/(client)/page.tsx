    ...
    return (
        <div className={'ion-page'}>
            <ion-content fullscreen scroll-y={true} className={'bg-gray-900'}>
                ...
                <Block nested className="bg-gray-900 min-h-full z-10 pb-12 w-full items-center justify-between font-mono text-sm lg:flex lg:flex-col lg:items-center lg:justify-center">
                    <Block nested className={'max-w-5xl'}>
                        ...
                        <Block nested className="relative flex place-items-center before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40 before:lg:h-[360px] z-[-1]">
                            <Image
                        ...
                        <Block nested className="mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
                            <a
              ...
              -&gt;
                        ...
                        <Block nested className={'text-zinc-200'}>
                            <Block nested>
